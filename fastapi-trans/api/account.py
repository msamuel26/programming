...
from services.account import create_account, get_account, update_account, delete_account, get_accounts
...
async def post_add_customer(request: Request, account: AccountInfo):
    print(account)
